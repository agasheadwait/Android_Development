...
class GameViewModel: ViewModel() {
    ...
    val hintWord = Transformations.map(word){
        word ->
        val randomNumber = (1..word.length).random()
        "Current word is "+ word.length.toString()+" letters long and the letter at position "+randomNumber.toString()+" is "+word.get(randomNumber-1).toUpperCase()
    }
